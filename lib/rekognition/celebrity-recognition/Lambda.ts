...
export class Lambda extends Construct {
  ...
  constructor(scope: Construct, id: string, {
    ...
    // Create Lambda functions for celebrity recognition
    this.startFunc = new NodejsFunction(scope, `StartCelebrityRecognitionFunction${id}`, {
    ...
    this.pollFunc = new NodejsFunction(scope, `PollCelebrityRekognitionFunction${id}`, {
      runtime: Runtime.NODEJS_18_X,
    ...
    this.getFunc = new NodejsFunction(scope, `GetCelebrityRekognitionFunction${id}`, {
      runtime: Runtime.NODEJS_18_X,
