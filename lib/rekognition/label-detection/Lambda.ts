...
export class Lambda extends Construct {
  ...
  constructor(scope: Construct, id: string, {
    ...
    // Create Lambda functions for label detection
    this.startFunc = new NodejsFunction(scope, `StartLabelRekognitionFunction${id}`, {
    ...
    this.pollFunc = new NodejsFunction(scope, `PollLabelRekognitionFunction${id}`, {
      runtime: Runtime.NODEJS_18_X,
    ...
    this.getFunc = new NodejsFunction(scope, `GetLabelRekognitionFunction${id}`, {
      runtime: Runtime.NODEJS_18_X,
